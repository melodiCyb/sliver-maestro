...
from skimage.morphology import skeletonize, area_closing, reconstruction, square, dilation
...
if __name__ == '__main__':
    ...
    generate_motion(svg_to_csv_base_path=svg_to_csv_base_path, scaled_base_path=scaled_base_path, final_motion=final_motion)
